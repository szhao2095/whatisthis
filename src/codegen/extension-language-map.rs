...
::phf::Map {
    ...
    entries: &[
        ...
        (".html", &["HTML"]),
        (".cls", &["Apex", "TeX", "VBA", "ObjectScript", "OpenEdge ABL"]),
        (".rkt", &["Racket"]),
        (".pm6", &["Raku"]),
        (".oz", &["Oz"]),
        (".mtml", &["MTML"]),
        ...
        (".snippet", &["Vim Snippet"]),
        (".v", &["Coq", "Verilog", "V"]),
        (".fcgi", &["Ruby", "Perl", "PHP", "Lua", "Python", "Shell"]),
        (".krl", &["KRL"]),
        (".cjsx", &["CoffeeScript"]),
        (".plt", &["Gnuplot"]),
        (".yasnippet", &["YASnippet"]),
        ...
        (".wxi", &["XML"]),
        (".asp", &["ASP"]),
        (".inc", &["HTML", "POV-Ray SDL", "C++", "SQL", "Pascal", "NASL", "Motorola 68K Assembly", "PHP", "SourcePawn", "Assembly", "Pawn"]),
        (".podsl", &["Common Lisp"]),
        (".jinja2", &["HTML+Django"]),
        (".gql", &["GraphQL"]),
        (".n", &["Nemerle", "Roff"]),
        ...
        (".nse", &["Lua"]),
        (".xpy", &["Python"]),
        (".m", &["MUF", "MATLAB", "Limbo", "M", "Mercury", "Objective-C", "Mathematica"]),
        (".vh", &["SystemVerilog"]),
        (".workflow", &["XML", "HCL"]),
        (".bdy", &["PLSQL"]),
        (".php5", &["PHP"]),
        ...
        (".js", &["JavaScript+CharCodeSubtract", "JavaScript+URIEncoded", "JavaScript+HexString", "JavaScript+ObfuscatorIO", "JavaScript", "JavaScript+JSFuck", "JavaScript+LongIdent", "JavaScript+Packer"]),
        (".3", &["Roff Manpage", "Roff"]),
        (".rbx", &["Ruby"]),
        (".bsv", &["Bluespec"]),
        (".tcl", &["Tcl"]),
        ...
        (".l", &["PicoLisp", "Common Lisp", "Lex", "Roff"]),
        (".jsonnet", &["Jsonnet"]),
        (".las", &["Lasso"]),
        (".druby", &["Mirah"]),
        (".c++-objdump", &["Cpp-ObjDump"]),
