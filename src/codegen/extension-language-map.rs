...
::phf::Map {
    ...
    entries: &[
        ...
        (".txi", &["Texinfo"]),
        (".geom", &["GLSL"]),
        (".js", &["JavaScript+LongIdent", "JavaScript", "JavaScript+HexString", "JavaScript+Packer", "JavaScript+CharCodeSubtract", "JavaScript+JSFuck", "JavaScript+ObfuscatorIO", "JavaScript+URIEncoded"]),
        (".rexx", &["REXX"]),
        (".gradle", &["Gradle"]),
        (".ado", &["Stata"]),
        (".mdpolicy", &["XML"]),
        ...
        (".gml", &["Game Maker Language", "XML", "Graph Modeling Language", "Gerber Image"]),
        ...
        (".no", &["Text"]),
        (".tsx", &["TSX", "XML"]),
        (".cls", &["OpenEdge ABL", "TeX", "ObjectScript", "VBA", "Apex"]),
        (".ccproj", &["XML"]),
        (".bsv", &["Bluespec"]),
        (".ninja", &["Ninja"]),
        (".xmi", &["XML"]),
        ...
        (".vhi", &["VHDL"]),
        (".jake", &["JavaScript"]),
        (".fcgi", &["Shell", "Python", "Ruby", "Lua", "Perl", "PHP"]),
        (".arc", &["Arc"]),
        (".udo", &["Csound"]),
        (".sql", &["SQLPL", "TSQL", "PLSQL", "PLpgSQL", "SQL"]),
        (".sexp", &["Common Lisp"]),
        (".pro", &["INI", "Proguard", "IDL", "QMake", "Prolog"]),
        (".ui", &["XML"]),
        (".apib", &["API Blueprint"]),
        (".xqm", &["XQuery"]),
        (".wisp", &["wisp"]),
        ...
        (".dcl", &["Clean"]),
        (".pluginspec", &["Ruby", "XML"]),
        (".inc", &["C++", "Assembly", "Pascal", "Motorola 68K Assembly", "Pawn", "SourcePawn", "SQL", "PHP", "NASL", "HTML", "POV-Ray SDL"]),
        (".yar", &["YARA"]),
        ...
        (".asd", &["Common Lisp"]),
        (".c++-objdump", &["Cpp-ObjDump"]),
        (".m", &["M", "Limbo", "Mercury", "MATLAB", "MUF", "Mathematica", "Objective-C"]),
        (".rhtml", &["RHTML"]),
        (".dot", &["Graphviz (DOT)"]),
        (".rsc", &["Rascal"]),
        (".fr", &["Frege", "Forth", "Text"]),
