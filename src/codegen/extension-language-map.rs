...
::phf::Map {
    ...
    entries: &[
        ...
        (".html", &["HTML"]),
        (".cls", &["OpenEdge ABL", "Apex", "ObjectScript", "TeX", "VBA"]),
        (".rkt", &["Racket"]),
        (".pm6", &["Raku"]),
        (".oz", &["Oz"]),
        (".mtml", &["MTML"]),
        ...
        (".snippet", &["Vim Snippet"]),
        (".v", &["Verilog", "V", "Coq"]),
        (".fcgi", &["Perl", "Python", "Ruby", "PHP", "Lua", "Shell"]),
        (".krl", &["KRL"]),
        (".cjsx", &["CoffeeScript"]),
        (".plt", &["Gnuplot"]),
        (".yasnippet", &["YASnippet"]),
        ...
        (".wxi", &["XML"]),
        (".asp", &["ASP"]),
        (".inc", &["Pawn", "POV-Ray SDL", "PHP", "Motorola 68K Assembly", "HTML", "SQL", "NASL", "SourcePawn", "Assembly", "Pascal", "C++"]),
        (".podsl", &["Common Lisp"]),
        (".jinja2", &["HTML+Django"]),
        (".gql", &["GraphQL"]),
        (".n", &["Nemerle", "Roff"]),
        ...
        (".nse", &["Lua"]),
        (".xpy", &["Python"]),
        (".m", &["Objective-C", "Mathematica", "Mercury", "MATLAB", "MUF", "Limbo", "M"]),
        (".vh", &["SystemVerilog"]),
        (".workflow", &["XML", "HCL"]),
        (".bdy", &["PLSQL"]),
        (".php5", &["PHP"]),
        ...
        (".js", &["JavaScript+URIEncoded", "JavaScript+JSFuck", "JavaScript+CharCodeSubtract", "JavaScript+LongIdent", "JavaScript", "JavaScript+Packer", "JavaScript+ObfuscatorIO", "JavaScript+HexString"]),
        (".3", &["Roff Manpage", "Roff"]),
        (".rbx", &["Ruby"]),
        (".bsv", &["Bluespec"]),
        (".tcl", &["Tcl"]),
        ...
        (".command", &["Shell"]),
        (".vb", &["Visual Basic .NET"]),
        (".sql", &["PLpgSQL", "SQLPL", "TSQL", "SQL", "PLSQL"]),
        (".pasm", &["Parrot Assembly"]),
        (".mod", &["AMPL", "XML", "Modula-2", "Linux Kernel Module"]),
        ...
        (".dpatch", &["Darcs Patch"]),
        (".gawk", &["Awk"]),
        (".pro", &["IDL", "QMake", "INI", "Proguard", "Prolog"]),
