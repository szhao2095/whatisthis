...
::phf::Map {
    ...
    entries: &[
        ...
        (".syntax", &["YAML"]),
        (".arpa", &["DNS Zone"]),
        (".inc", &["SourcePawn", "Assembly", "Pawn", "HTML", "SQL", "NASL", "C++", "POV-Ray SDL", "Motorola 68K Assembly", "PHP", "Pascal"]),
        (".hql", &["HiveQL"]),
        (".asmx", &["ASP"]),
        (".gn", &["GN"]),
        ...
        (".pro", &["Prolog", "INI", "QMake", "Proguard", "IDL"]),
        (".nimrod", &["Nim"]),
        (".dpatch", &["Darcs Patch"]),
        (".rabl", &["Ruby"]),
        (".moo", &["Moocode", "Mercury"]),
        ...
        (".rktl", &["Racket"]),
        (".ol", &["Jolie"]),
        (".cls", &["VBA", "ObjectScript", "OpenEdge ABL", "Apex", "TeX"]),
        (".pod6", &["Pod 6"]),
        (".gms", &["GAMS"]),
        ...
        (".m", &["M", "Limbo", "MUF", "Mathematica", "MATLAB", "Mercury", "Objective-C"]),
        (".nuspec", &["XML"]),
        (".bibtex", &["BibTeX"]),
        (".8xp.txt", &["TI Program"]),
        (".sbt", &["Scala"]),
        ...
        (".ncl", &["XML", "Text", "NCL"]),
        (".vshader", &["GLSL"]),
        (".x", &["Logos", "Linker Script", "RPC", "DirectX 3D File"]),
        (".r", &["Rebol", "R"]),
        (".srdf", &["XML"]),
        (".mcmeta", &["JSON"]),
        (".har", &["JSON"]),
        ...
        (".h++", &["C++"]),
        (".m4", &["M4", "M4Sugar"]),
        (".sql", &["PLSQL", "SQL", "PLpgSQL", "SQLPL", "TSQL"]),
        (".nasl", &["NASL"]),
        (".scm", &["Scheme"]),
        (".pony", &["Pony"]),
        (".scala", &["Scala"]),
